...
import { Button, DatePicker, Form, Input, Table, TableColumnsType } from "antd";
...
const CategoryStatistic = () => {
  ...
  const [form] = useForm();
  const filteredData: ITopCategoryStatisticExtend[] = topCategoryList.map(
    (t, index) => {
      return {
        ...t,
        index: index + 1,
  ...
  const columns: TableColumnsType<ITopCategoryStatisticExtend> = [
    ...
    },
    {
      ...
      sorter: (a, b) => parseInt(a.borrowCount) - parseInt(b.borrowCount),
    },
  ];
        ...
        <Form form={form} onFinish={onFinish}>
          <div className="flex gap-2">
            ...
            <Form.Item name={"search"}>
              <Input size="large" placeholder="Search for categories..." />
            </Form.Item>
            <Button
              size="large"
              htmlType="submit"
